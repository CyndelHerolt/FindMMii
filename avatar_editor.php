...
//    echo '<span class="name"> Veuillez vous connecter </span> ';
...
<main id="avatar_editor">
    <article>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <img onclick="hairbold()" id="cheveux31" class="aperçu" src="avatar/cheveux/none.svg" alt="cheveux">
        ...
        <script>
            ...
            function hairbrun1() {
                document.getElementById('hair1brun').style.visibility = "visible";
                document.getElementById('hair1chatain').style.visibility = "hidden";
                document.getElementById('hair1blond').style.visibility = "hidden";
                document.getElementById('hair1roux').style.visibility = "hidden";
                document.getElementById('hair1rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "hidden";
                document.getElementById('hair2rouge').style.visibility = "hidden";
                document.getElementById('hair3brun').style.visibility = "hidden";
                document.getElementById('hair3chatain').style.visibility = "hidden";
                document.getElementById('hair3blond').style.visibility = "hidden";
                document.getElementById('hair3roux').style.visibility = "hidden";
                document.getElementById('hair3rouge').style.visibility = "hidden";
                document.getElementById('hair4brun').style.visibility = "hidden";
                document.getElementById('hair4chatain').style.visibility = "hidden";
                document.getElementById('hair4blond').style.visibility = "hidden";
                document.getElementById('hair4roux').style.visibility = "hidden";
                document.getElementById('hair4rouge').style.visibility = "hidden";
                document.getElementById('hair5brun').style.visibility = "hidden";
                document.getElementById('hair5chatain').style.visibility = "hidden";
                document.getElementById('hairblond').style.visibility = "hidden";
                document.getElementById('hair5roux').style.visibility = "hidden";
                document.getElementById('hair5rouge').style.visibility = "hidden";
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "hidden";
                document.getElementById('hair6blond').style.visibility = "hidden";
                document.getElementById('hair6roux').style.visibility = "hidden";
                document.getElementById('hair6rouge').style.visibility = "hidden";
                document.getElementById('hair7brun').style.visibility = "hidden";
                document.getElementById('hair7chatain').style.visibility = "hidden";
                document.getElementById('hair7blond').style.visibility = "hidden";
                document.getElementById('hair7roux').style.visibility = "hidden";
                document.getElementById('hair7rouge').style.visibility = "hidden";
            }


            function hairchatain1() {
                document.getElementById('hair1brun').style.visibility = "hidden";
                document.getElementById('hair1chatain').style.visibility = "visible";
                document.getElementById('hair1blond').style.visibility = "hidden";
                document.getElementById('hair1roux').style.visibility = "hidden";
                document.getElementById('hair1rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
                ...
                document.getElementById('hair5brun').style.visibility = "hidden";
                document.getElementById('hair5chatain').style.visibility = "hidden";
                document.getElementById('hair5blond').style.visibility = "hidden";
                document.getElementById('hair5roux').style.visibility = "hidden";
                document.getElementById('hair5rouge').style.visibility = "hidden";
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "hidden";
            ...
            function hairblond1() {
                document.getElementById('hair1brun').style.visibility = "hidden";
                document.getElementById('hair1chatain').style.visibility = "hidden";
                document.getElementById('hair1blond').style.visibility = "visible";
                document.getElementById('hair1roux').style.visibility = "hidden";
                document.getElementById('hair1rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
            ...
            function hairroux1() {
                ...
                document.getElementById('hair1chatain').style.visibility = "hidden";
                document.getElementById('hair1blond').style.visibility = "hidden";
                document.getElementById('hair1roux').style.visibility = "visible";
                document.getElementById('hair1rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
            ...
            function hairrouge1() {
                ...
                document.getElementById('hair1blond').style.visibility = "hidden";
                document.getElementById('hair1roux').style.visibility = "hidden";
                document.getElementById('hair1rouge').style.visibility = "visible";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "hidden";
            ...
            function hairbrun2() {
                document.getElementById('hair2brun').style.visibility = "visible";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "hidden";
                document.getElementById('hair2rouge').style.visibility = "hidden";
            ...
            function hairchatain2() {
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "visible";
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "hidden";
                document.getElementById('hair2rouge').style.visibility = "hidden";
                document.getElementById('hair1brun').style.visibility = "hidden";
            ...
            function hairblond2() {
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "visible";
                document.getElementById('hair2roux').style.visibility = "hidden";
                document.getElementById('hair2rouge').style.visibility = "hidden";
                document.getElementById('hair1brun').style.visibility = "hidden";
                document.getElementById('hair1chatain').style.visibility = "hidden";
            ...
            function hairroux2() {
                ...
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "visible";
                document.getElementById('hair2rouge').style.visibility = "hidden";
                document.getElementById('hair1brun').style.visibility = "hidden";
                document.getElementById('hair1chatain').style.visibility = "hidden";
                document.getElementById('hair1blond').style.visibility = "hidden";
            ...
            function hairrouge2() {
                ...
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "hidden";
                document.getElementById('hair2rouge').style.visibility = "visible";
                document.getElementById('hair1brun').style.visibility = "hidden";
                document.getElementById('hair1chatain').style.visibility = "hidden";
                document.getElementById('hair1blond').style.visibility = "hidden";
                document.getElementById('hair1roux').style.visibility = "hidden";
            ...
            function hairbrun3() {
                document.getElementById('hair3brun').style.visibility = "visible";
                document.getElementById('hair3chatain').style.visibility = "hidden";
                document.getElementById('hair3blond').style.visibility = "hidden";
                document.getElementById('hair3roux').style.visibility = "hidden";
                document.getElementById('hair3rouge').style.visibility = "hidden";
            ...
            function hairchatain3() {
                document.getElementById('hair3brun').style.visibility = "hidden";
                document.getElementById('hair3chatain').style.visibility = "visible";
                document.getElementById('hair3blond').style.visibility = "hidden";
                document.getElementById('hair3roux').style.visibility = "hidden";
                document.getElementById('hair3rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
            ...
            function hairblond3() {
                document.getElementById('hair3brun').style.visibility = "hidden";
                document.getElementById('hair3chatain').style.visibility = "hidden";
                document.getElementById('hair3blond').style.visibility = "visible";
                document.getElementById('hair3roux').style.visibility = "hidden";
                document.getElementById('hair3rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
            ...
            function hairroux3() {
                ...
                document.getElementById('hair3chatain').style.visibility = "hidden";
                document.getElementById('hair3blond').style.visibility = "hidden";
                document.getElementById('hair3roux').style.visibility = "visible";
                document.getElementById('hair3rouge').style.visibility = "hidden";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
            ...
            function hairrouge3() {
                ...
                document.getElementById('hair3blond').style.visibility = "hidden";
                document.getElementById('hair3roux').style.visibility = "hidden";
                document.getElementById('hair3rouge').style.visibility = "visible";
                document.getElementById('hair2brun').style.visibility = "hidden";
                document.getElementById('hair2chatain').style.visibility = "hidden";
                document.getElementById('hair2blond').style.visibility = "hidden";
                document.getElementById('hair2roux').style.visibility = "hidden";
            ...
            function hairbrun4() {
                document.getElementById('hair4brun').style.visibility = "visible";
                document.getElementById('hair4chatain').style.visibility = "hidden";
                document.getElementById('hair4blond').style.visibility = "hidden";
                document.getElementById('hair4roux').style.visibility = "hidden";
                document.getElementById('hair4rouge').style.visibility = "hidden";
            ...
            function hairchatain4() {
                document.getElementById('hair4brun').style.visibility = "hidden";
                document.getElementById('hair4chatain').style.visibility = "visible";
                document.getElementById('hair4blond').style.visibility = "hidden";
                document.getElementById('hair4roux').style.visibility = "hidden";
                document.getElementById('hair4rouge').style.visibility = "hidden";
                document.getElementById('hair1brun').style.visibility = "hidden";
            ...
            function hairblond4() {
                document.getElementById('hair4brun').style.visibility = "hidden";
                document.getElementById('hair4chatain').style.visibility = "hidden";
                document.getElementById('hair4blond').style.visibility = "visible";
                document.getElementById('hair4roux').style.visibility = "hidden";
                document.getElementById('hair4rouge').style.visibility = "hidden";
                document.getElementById('hair3brun').style.visibility = "hidden";
                document.getElementById('hair3chatain').style.visibility = "hidden";
            ...
            function hairroux4() {
                ...
                document.getElementById('hair4chatain').style.visibility = "hidden";
                document.getElementById('hair4blond').style.visibility = "hidden";
                document.getElementById('hair4roux').style.visibility = "visible";
                document.getElementById('hair4rouge').style.visibility = "hidden";
                document.getElementById('hair3brun').style.visibility = "hidden";
                document.getElementById('hair3chatain').style.visibility = "hidden";
                document.getElementById('hair3blond').style.visibility = "hidden";
            ...
            function hairrouge4() {
                ...
                document.getElementById('hair4blond').style.visibility = "hidden";
                document.getElementById('hair4roux').style.visibility = "hidden";
                document.getElementById('hair4rouge').style.visibility = "visible";
                document.getElementById('hair3brun').style.visibility = "hidden";
                document.getElementById('hair3chatain').style.visibility = "hidden";
                document.getElementById('hair3blond').style.visibility = "hidden";
                document.getElementById('hair3roux').style.visibility = "hidden";
            ...
            function hairbrun5() {
                document.getElementById('hair5brun').style.visibility = "visible";
                document.getElementById('hair5chatain').style.visibility = "hidden";
                document.getElementById('hair5blond').style.visibility = "hidden";
                document.getElementById('hair5roux').style.visibility = "hidden";
                document.getElementById('hair5rouge').style.visibility = "hidden";
            ...
            function hairchatain5() {
                document.getElementById('hair5brun').style.visibility = "hidden";
                document.getElementById('hair5chatain').style.visibility = "visible";
                document.getElementById('hair5blond').style.visibility = "hidden";
                document.getElementById('hair5roux').style.visibility = "hidden";
                document.getElementById('hair5rouge').style.visibility = "hidden";
                document.getElementById('hair4brun').style.visibility = "hidden";
            ...
            function hairblond5() {
                document.getElementById('hair5brun').style.visibility = "hidden";
                document.getElementById('hair5chatain').style.visibility = "hidden";
                document.getElementById('hair5blond').style.visibility = "visible";
                document.getElementById('hair5roux').style.visibility = "hidden";
                document.getElementById('hair5rouge').style.visibility = "hidden";
                document.getElementById('hair4brun').style.visibility = "hidden";
                document.getElementById('hair4chatain').style.visibility = "hidden";
            ...
            function hairroux5() {
                ...
                document.getElementById('hair5chatain').style.visibility = "hidden";
                document.getElementById('hair5blond').style.visibility = "hidden";
                document.getElementById('hair5roux').style.visibility = "visible";
                document.getElementById('hair5rouge').style.visibility = "hidden";
                document.getElementById('hair4brun').style.visibility = "hidden";
                document.getElementById('hair4chatain').style.visibility = "hidden";
                document.getElementById('hair4blond').style.visibility = "hidden";
            ...
            function hairrouge5() {
                ...
                document.getElementById('hair5blond').style.visibility = "hidden";
                document.getElementById('hair5roux').style.visibility = "hidden";
                document.getElementById('hair5rouge').style.visibility = "visible";
                document.getElementById('hair4brun').style.visibility = "hidden";
                document.getElementById('hair4chatain').style.visibility = "hidden";
                document.getElementById('hair4blond').style.visibility = "hidden";
                document.getElementById('hair4roux').style.visibility = "hidden";
            ...
            function hairbrun6() {
                document.getElementById('hair6brun').style.visibility = "visible";
                document.getElementById('hair6chatain').style.visibility = "hidden";
                document.getElementById('hair6blond').style.visibility = "hidden";
                document.getElementById('hair6roux').style.visibility = "hidden";
                document.getElementById('hair6rouge').style.visibility = "hidden";
            ...
            function hairchatain6() {
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "visible";
                document.getElementById('hair6blond').style.visibility = "hidden";
                document.getElementById('hair6roux').style.visibility = "hidden";
                document.getElementById('hair6rouge').style.visibility = "hidden";
                document.getElementById('hair7brun').style.visibility = "hidden";
            ...
            function hairblond6() {
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "hidden";
                document.getElementById('hair6blond').style.visibility = "visible";
                document.getElementById('hair6roux').style.visibility = "hidden";
                document.getElementById('hair6rouge').style.visibility = "hidden";
                document.getElementById('hair7brun').style.visibility = "hidden";
                document.getElementById('hair7chatain').style.visibility = "hidden";
            ...
            function hairroux6() {
                ...
                document.getElementById('hair6chatain').style.visibility = "hidden";
                document.getElementById('hair6blond').style.visibility = "hidden";
                document.getElementById('hair6roux').style.visibility = "visible";
                document.getElementById('hair6rouge').style.visibility = "hidden";
                document.getElementById('hair7brun').style.visibility = "hidden";
                document.getElementById('hair7chatain').style.visibility = "hidden";
                document.getElementById('hair7blond').style.visibility = "hidden";
            ...
            function hairrouge6() {
                ...
                document.getElementById('hair6blond').style.visibility = "hidden";
                document.getElementById('hair6roux').style.visibility = "hidden";
                document.getElementById('hair6rouge').style.visibility = "visible";
                document.getElementById('hair7brun').style.visibility = "hidden";
                document.getElementById('hair7chatain').style.visibility = "hidden";
                document.getElementById('hair7blond').style.visibility = "hidden";
                document.getElementById('hair7roux').style.visibility = "hidden";
            ...
            function hairbrun7() {
                document.getElementById('hair7brun').style.visibility = "visible";
                document.getElementById('hair7chatain').style.visibility = "hidden";
                document.getElementById('hair7blond').style.visibility = "hidden";
                document.getElementById('hair7roux').style.visibility = "hidden";
                document.getElementById('hair7rouge').style.visibility = "hidden";
            ...
            function hairchatain7() {
                document.getElementById('hair7brun').style.visibility = "hidden";
                document.getElementById('hair7chatain').style.visibility = "visible";
                document.getElementById('hair7blond').style.visibility = "hidden";
                document.getElementById('hair7roux').style.visibility = "hidden";
                document.getElementById('hair7rouge').style.visibility = "hidden";
                document.getElementById('hair6brun').style.visibility = "hidden";
            ...
            function hairblond7() {
                document.getElementById('hair7brun').style.visibility = "hidden";
                document.getElementById('hair7chatain').style.visibility = "hidden";
                document.getElementById('hair7blond').style.visibility = "visible";
                document.getElementById('hair7roux').style.visibility = "hidden";
                document.getElementById('hair7rouge').style.visibility = "hidden";
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "hidden";
            ...
            function hairroux7() {
                ...
                document.getElementById('hair7chatain').style.visibility = "hidden";
                document.getElementById('hair7blond').style.visibility = "hidden";
                document.getElementById('hair7roux').style.visibility = "visible";
                document.getElementById('hair7rouge').style.visibility = "hidden";
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "hidden";
                document.getElementById('hair6blond').style.visibility = "hidden";
            ...
            function hairrouge7() {
                ...
                document.getElementById('hair7blond').style.visibility = "hidden";
                document.getElementById('hair7roux').style.visibility = "hidden";
                document.getElementById('hair7rouge').style.visibility = "visible";
                document.getElementById('hair6brun').style.visibility = "hidden";
                document.getElementById('hair6chatain').style.visibility = "hidden";
                document.getElementById('hair6blond').style.visibility = "hidden";
                document.getElementById('hair6roux').style.visibility = "hidden";
        ...
        <script>
            function yeux1(){
                document.getElementById('eyes1').style.visibility = "visible";
                document.getElementById('eyes2').style.visibility = "hidden";
                document.getElementById('eyes3').style.visibility = "hidden";
                document.getElementById('eyes4').style.visibility = "hidden";
                document.getElementById('eyes5').style.visibility = "hidden";
                document.getElementById('eyes6').style.visibility = "hidden";
                document.getElementById('eyes7').style.visibility = "hidden";
                document.getElementById('eyes8').style.visibility = "hidden";
                document.getElementById('eyes9').style.visibility = "hidden";
                document.getElementById('eyes10').style.visibility = "hidden";
                document.getElementById('eyes11').style.visibility = "hidden";
                document.getElementById('eyes12').style.visibility = "hidden";
                document.getElementById('eyes13').style.visibility = "hidden";
                document.getElementById('eyes14').style.visibility = "hidden";
            }

            function yeux2(){
                document.getElementById('eyes1').style.visibility = "hidden";
            ...
            function yeux3(){
                document.getElementById('eyes1').style.visibility = "hidden";
                document.getElementById('eyes2').style.visibility = "hidden";
                document.getElementById('eyes3').style.visibility = "visible";
                document.getElementById('eyes4').style.visibility = "hidden";
                document.getElementById('eyes5').style.visibility = "hidden";
                document.getElementById('eyes6').style.visibility = "hidden";
                document.getElementById('eyes7').style.visibility = "hidden";
            ...
            function yeux4(){
                ...
                document.getElementById('eyes2').style.visibility = "hidden";
                document.getElementById('eyes3').style.visibility = "hidden";
                document.getElementById('eyes4').style.visibility = "visible";
                document.getElementById('eyes5').style.visibility = "hidden";
                document.getElementById('eyes6').style.visibility = "hidden";
                document.getElementById('eyes7').style.visibility = "hidden";
                document.getElementById('eyes8').style.visibility = "hidden";
            ...
            function yeux5(){
                ...
                document.getElementById('eyes3').style.visibility = "hidden";
                document.getElementById('eyes4').style.visibility = "hidden";
                document.getElementById('eyes5').style.visibility = "visible";
                document.getElementById('eyes6').style.visibility = "hidden";
                document.getElementById('eyes7').style.visibility = "hidden";
                document.getElementById('eyes8').style.visibility = "hidden";
                document.getElementById('eyes9').style.visibility = "hidden";
            ...
            function yeux6(){
                ...
                document.getElementById('eyes4').style.visibility = "hidden";
                document.getElementById('eyes5').style.visibility = "hidden";
                document.getElementById('eyes6').style.visibility = "visible";
                document.getElementById('eyes7').style.visibility = "hidden";
                document.getElementById('eyes8').style.visibility = "hidden";
                document.getElementById('eyes9').style.visibility = "hidden";
                document.getElementById('eyes10').style.visibility = "hidden";
            ...
            function yeux7(){
                ...
                document.getElementById('eyes5').style.visibility = "hidden";
                document.getElementById('eyes6').style.visibility = "hidden";
                document.getElementById('eyes7').style.visibility = "visible";
                document.getElementById('eyes8').style.visibility = "hidden";
                document.getElementById('eyes9').style.visibility = "hidden";
                document.getElementById('eyes10').style.visibility = "hidden";
                document.getElementById('eyes11').style.visibility = "hidden";
            ...
            function yeux8(){
                ...
                document.getElementById('eyes6').style.visibility = "hidden";
                document.getElementById('eyes7').style.visibility = "hidden";
                document.getElementById('eyes8').style.visibility = "visible";
                document.getElementById('eyes9').style.visibility = "hidden";
                document.getElementById('eyes10').style.visibility = "hidden";
                document.getElementById('eyes11').style.visibility = "hidden";
                document.getElementById('eyes12').style.visibility = "hidden";
            ...
            function yeux9(){
                ...
                document.getElementById('eyes7').style.visibility = "hidden";
                document.getElementById('eyes8').style.visibility = "hidden";
                document.getElementById('eyes9').style.visibility = "visible";
                document.getElementById('eyes10').style.visibility = "hidden";
                document.getElementById('eyes11').style.visibility = "hidden";
                document.getElementById('eyes12').style.visibility = "hidden";
                document.getElementById('eyes13').style.visibility = "hidden";
            ...
            function yeux10(){
                ...
                document.getElementById('eyes8').style.visibility = "hidden";
                document.getElementById('eyes9').style.visibility = "hidden";
                document.getElementById('eyes10').style.visibility = "visible";
                document.getElementById('eyes11').style.visibility = "hidden";
                document.getElementById('eyes12').style.visibility = "hidden";
                document.getElementById('eyes13').style.visibility = "hidden";
                document.getElementById('eyes14').style.visibility = "hidden";
            ...
            function yeux11(){
                ...
                document.getElementById('eyes9').style.visibility = "hidden";
                document.getElementById('eyes10').style.visibility = "hidden";
                document.getElementById('eyes11').style.visibility = "visible";
                document.getElementById('eyes12').style.visibility = "hidden";
                document.getElementById('eyes13').style.visibility = "hidden";
                document.getElementById('eyes14').style.visibility = "hidden";
            }
            ...
            function yeux12(){
                ...
                document.getElementById('eyes10').style.visibility = "hidden";
                document.getElementById('eyes11').style.visibility = "hidden";
                document.getElementById('eyes12').style.visibility = "visible";
                document.getElementById('eyes13').style.visibility = "hidden";
                document.getElementById('eyes14').style.visibility = "hidden";
            }
            ...
            function yeux13(){
                ...
                document.getElementById('eyes11').style.visibility = "hidden";
                document.getElementById('eyes12').style.visibility = "hidden";
                document.getElementById('eyes13').style.visibility = "visible";
                document.getElementById('eyes14').style.visibility = "hidden";
            }
            ...
            function yeux14(){
                ...
                document.getElementById('eyes12').style.visibility = "hidden";
                document.getElementById('eyes13').style.visibility = "hidden";
                document.getElementById('eyes14').style.visibility = "visible";
            }
        </script>

        <script>
            function mouth1(){
                document.getElementById('mouths1').style.visibility = "visible";
                document.getElementById('mouths2').style.visibility = "hidden";
                document.getElementById('mouths3').style.visibility = "hidden";
                document.getElementById('mouths4').style.visibility = "hidden";
                document.getElementById('mouths5').style.visibility = "hidden";
                document.getElementById('mouths6').style.visibility = "hidden";
                document.getElementById('mouths7').style.visibility = "hidden";
            }
            function mouth2(){
                document.getElementById('mouths1').style.visibility = "hidden";
                document.getElementById('mouths2').style.visibility = "visible";
                document.getElementById('mouths3').style.visibility = "hidden";
                document.getElementById('mouths4').style.visibility = "hidden";
                document.getElementById('mouths5').style.visibility = "hidden";
                document.getElementById('mouths6').style.visibility = "hidden";
            ...
            function mouth3(){
                document.getElementById('mouths1').style.visibility = "hidden";
                document.getElementById('mouths2').style.visibility = "hidden";
                document.getElementById('mouths3').style.visibility = "visible";
                document.getElementById('mouths4').style.visibility = "hidden";
                document.getElementById('mouths5').style.visibility = "hidden";
                document.getElementById('mouths6').style.visibility = "hidden";
                document.getElementById('mouths7').style.visibility = "hidden";
            ...
            function mouth4(){
                ...
                document.getElementById('mouths2').style.visibility = "hidden";
                document.getElementById('mouths3').style.visibility = "hidden";
                document.getElementById('mouths4').style.visibility = "visible";
                document.getElementById('mouths5').style.visibility = "hidden";
                document.getElementById('mouths6').style.visibility = "hidden";
                document.getElementById('mouths7').style.visibility = "hidden";
            }
            ...
            function mouth5(){
                ...
                document.getElementById('mouths3').style.visibility = "hidden";
                document.getElementById('mouths4').style.visibility = "hidden";
                document.getElementById('mouths5').style.visibility = "visible";
                document.getElementById('mouths6').style.visibility = "hidden";
                document.getElementById('mouths7').style.visibility = "hidden";
            }
            ...
            function mouth6(){
                ...
                document.getElementById('mouths4').style.visibility = "hidden";
                document.getElementById('mouths5').style.visibility = "hidden";
                document.getElementById('mouths6').style.visibility = "visible";
                document.getElementById('mouths7').style.visibility = "hidden";
            }
            ...
            function mouth7(){
                ...
                document.getElementById('mouths5').style.visibility = "hidden";
                document.getElementById('mouths6').style.visibility = "hidden";
                document.getElementById('mouths7').style.visibility = "visible";
            }
        </script>

        <script>
            function clothes1(){
                document.getElementById('chemise1').style.visibility = "visible";
                document.getElementById('chemise2').style.visibility = "hidden";
                document.getElementById('chemise3').style.visibility = "hidden";
                document.getElementById('chemise4').style.visibility = "hidden";
                document.getElementById('gilet1').style.visibility = "hidden";
                document.getElementById('gilet2').style.visibility = "hidden";
                document.getElementById('gilet3').style.visibility = "hidden";
                document.getElementById('gilet4').style.visibility = "hidden";
                ...
                document.getElementById('sweat1').style.visibility = "hidden";
                document.getElementById('sweat2').style.visibility = "hidden";
                document.getElementById('sweat3').style.visibility = "hidden";
                document.getElementById('sweat4').style.visibility = "hidden";
                document.getElementById('tshirt1').style.visibility = "hidden";
                document.getElementById('tshirt2').style.visibility = "hidden";
                document.getElementById('tshirt3').style.visibility = "hidden";
                document.getElementById('tshirt4').style.visibility = "hidden";
            }

            function clothes2(){
                document.getElementById('chemise1').style.visibility = "hidden";
                document.getElementById('chemise2').style.visibility = "visible";
                document.getElementById('chemise3').style.visibility = "hidden";
                document.getElementById('chemise4').style.visibility = "hidden";
                document.getElementById('gilet1').style.visibility = "hidden";
                document.getElementById('gilet2').style.visibility = "hidden";
            ...
            function clothes3(){
                document.getElementById('chemise1').style.visibility = "hidden";
                document.getElementById('chemise2').style.visibility = "hidden";
                document.getElementById('chemise3').style.visibility = "visible";
                document.getElementById('chemise4').style.visibility = "hidden";
                document.getElementById('gilet1').style.visibility = "hidden";
                document.getElementById('gilet2').style.visibility = "hidden";
                document.getElementById('gilet3').style.visibility = "hidden";
            ...
            function clothes4(){
                ...
                document.getElementById('chemise2').style.visibility = "hidden";
                document.getElementById('chemise3').style.visibility = "hidden";
                document.getElementById('chemise4').style.visibility = "visible";
                document.getElementById('gilet1').style.visibility = "hidden";
                document.getElementById('gilet2').style.visibility = "hidden";
                document.getElementById('gilet3').style.visibility = "hidden";
                document.getElementById('gilet4').style.visibility = "hidden";
            ...
            function clothes5(){
                ...
                document.getElementById('chemise3').style.visibility = "hidden";
                document.getElementById('chemise4').style.visibility = "hidden";
                document.getElementById('gilet1').style.visibility = "visible";
                document.getElementById('gilet2').style.visibility = "hidden";
                document.getElementById('gilet3').style.visibility = "hidden";
                document.getElementById('gilet4').style.visibility = "hidden";
                document.getElementById('pull1').style.visibility = "hidden";
            ...
            function clothes6(){
                ...
                document.getElementById('chemise4').style.visibility = "hidden";
                document.getElementById('gilet1').style.visibility = "hidden";
                document.getElementById('gilet2').style.visibility = "visible";
                document.getElementById('gilet3').style.visibility = "hidden";
                document.getElementById('gilet4').style.visibility = "hidden";
                document.getElementById('pull1').style.visibility = "hidden";
                document.getElementById('pull2').style.visibility = "hidden";
            ...
            function clothes7(){
                ...
                document.getElementById('gilet1').style.visibility = "hidden";
                document.getElementById('gilet2').style.visibility = "hidden";
                document.getElementById('gilet3').style.visibility = "visible";
                document.getElementById('gilet4').style.visibility = "hidden";
                document.getElementById('pull1').style.visibility = "hidden";
                document.getElementById('pull2').style.visibility = "hidden";
                document.getElementById('pull3').style.visibility = "hidden";
            ...
            function clothes8(){
                ...
                document.getElementById('gilet2').style.visibility = "hidden";
                document.getElementById('gilet3').style.visibility = "hidden";
                document.getElementById('gilet4').style.visibility = "visible";
                document.getElementById('pull1').style.visibility = "hidden";
                document.getElementById('pull2').style.visibility = "hidden";
                document.getElementById('pull3').style.visibility = "hidden";
                document.getElementById('pull4').style.visibility = "hidden";
            ...
            function clothes12(){
                ...
                document.getElementById('pull2').style.visibility = "hidden";
                document.getElementById('pull3').style.visibility = "hidden";
                document.getElementById('pull4').style.visibility = "visible";
                document.getElementById('sweat1').style.visibility = "hidden";
                document.getElementById('sweat2').style.visibility = "hidden";
                document.getElementById('sweat3').style.visibility = "hidden";
                document.getElementById('sweat4').style.visibility = "hidden";
            ...
            function clothes13(){
                ...
                document.getElementById('pull3').style.visibility = "hidden";
                document.getElementById('pull4').style.visibility = "hidden";
                document.getElementById('sweat1').style.visibility = "visible";
                document.getElementById('sweat2').style.visibility = "hidden";
                document.getElementById('sweat3').style.visibility = "hidden";
                document.getElementById('sweat4').style.visibility = "hidden";
                document.getElementById('tshirt1').style.visibility = "hidden";
            ...
            function clothes14(){
                ...
                document.getElementById('pull4').style.visibility = "hidden";
                document.getElementById('sweat1').style.visibility = "hidden";
                document.getElementById('sweat2').style.visibility = "visible";
                document.getElementById('sweat3').style.visibility = "hidden";
                document.getElementById('sweat4').style.visibility = "hidden";
                document.getElementById('tshirt1').style.visibility = "hidden";
                document.getElementById('tshirt2').style.visibility = "hidden";
            ...
            function clothes15(){
                ...
                document.getElementById('sweat1').style.visibility = "hidden";
                document.getElementById('sweat2').style.visibility = "hidden";
                document.getElementById('sweat3').style.visibility = "visible";
                document.getElementById('sweat4').style.visibility = "hidden";
                document.getElementById('tshirt1').style.visibility = "hidden";
                document.getElementById('tshirt2').style.visibility = "hidden";
                document.getElementById('tshirt3').style.visibility = "hidden";
            ...
            function clothes16(){
                ...
                document.getElementById('sweat2').style.visibility = "hidden";
                document.getElementById('sweat3').style.visibility = "hidden";
                document.getElementById('sweat4').style.visibility = "visible";
                document.getElementById('tshirt1').style.visibility = "hidden";
                document.getElementById('tshirt2').style.visibility = "hidden";
                document.getElementById('tshirt3').style.visibility = "hidden";
                document.getElementById('tshirt4').style.visibility = "hidden";
            ...
            function clothes17(){
                ...
                document.getElementById('sweat3').style.visibility = "hidden";
                document.getElementById('sweat4').style.visibility = "hidden";
                document.getElementById('tshirt1').style.visibility = "visible";
                document.getElementById('tshirt2').style.visibility = "hidden";
                document.getElementById('tshirt3').style.visibility = "hidden";
                document.getElementById('tshirt4').style.visibility = "hidden";
            }
            ...
            function clothes18(){
                ...
                document.getElementById('sweat4').style.visibility = "hidden";
                document.getElementById('tshirt1').style.visibility = "hidden";
                document.getElementById('tshirt2').style.visibility = "visible";
                document.getElementById('tshirt3').style.visibility = "hidden";
                document.getElementById('tshirt4').style.visibility = "hidden";
            }
            ...
            function clothes19(){
                ...
                document.getElementById('tshirt1').style.visibility = "hidden";
                document.getElementById('tshirt2').style.visibility = "hidden";
                document.getElementById('tshirt3').style.visibility = "visible";
                document.getElementById('tshirt4').style.visibility = "hidden";
            }
            ...
            function clothes20(){
                ...
                document.getElementById('tshirt2').style.visibility = "hidden";
                document.getElementById('tshirt3').style.visibility = "hidden";
                document.getElementById('tshirt4').style.visibility = "visible";
            }
        </script>

        <script>
            function glasses1(){
                document.getElementById('glass1').style.visibility = "visible";
        ...
        <div class="center_btn">
            <button type="button" class="btn btn-primary modal_btn" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="takeshot()">Créer</button>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Alors, satisfait ?</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary modal_btn sauvegarder">Sauvegarder</button>
                        <input class="modal_btn" type="button" value="Télécharger" onclick="candown('demo', 'png')" />
                        <button type="button" class="btn btn-secondary modal_btn" data-bs-dismiss="modal">Retour à l'éditeur</button>
                        ...
                        <script>
                            function candown(target, type) {
                                ...
                                anchor.download = "avatar_." + type;
                                anchor.href = canvas.toDataURL("image/" + type);


                                // sauvegarder.href = canvas.toDataURL("image/" + type);
                                ...
                                //anchor.innerHTML = "Télécharger l'image";
                            ...
                            $(".sauvegarder").click(function() {
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        // location.href = 'sauvegarde.php';
                                        alert("Votre image à bien été sauvegardée");
                                    }
                                });
                            });
