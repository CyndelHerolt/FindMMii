...
<script>
    ...
    <input type="button" value="PNG" onclick="candown('demo', 'png')" />


    <?php
    if (empty($_SESSION['prenom_client'])) {
        echo '<span class="name"> Pour pouvoir sauvegarder l\'image dans votre profil veuillez vous connecter ! </span> ';
    } else {
        echo '<button class="sauvegarder">Sauvegarder</button> ';
    }
    ?>
    <script>
